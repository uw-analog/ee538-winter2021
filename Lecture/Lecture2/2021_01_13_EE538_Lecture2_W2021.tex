...
\item
  However, if \(V_{GS1}\) is changed slightly, the resulting operating
...
\PY{n}{V\PYZus{}GS1} \PY{o}{=} \PY{o}{.}\PY{l+m+mi}{9}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2021_01_13_EE538_Lecture2_W2021_files/2021_01_13_EE538_Lecture2_W2021_60_0.png}
    \end{center}
    { \hspace*{\fill} \\}
